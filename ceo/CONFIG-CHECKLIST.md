...
| 事项 | 优先级 | 截止日 | 状态 | 备注 |
|------|--------|--------|------|------|
| 微信咨询号 | 高 | 3/28 | ❌ 已逾期 38 天 | 若有咨询无法承接 |
| 百度统计 ID | 高 | 3/28 | ❌ 已逾期 38 天 | 数据追踪缺失 |
| 域名购买 | 中 | 3/30 | ❌ 已逾期 36 天 | 仍使用免费域名 |
| 收款码/支付方式 | 高 | 3/30 | ❌ 已逾期 36 天 | 若有付费无法收款 |
| Warm intro 名单 | 高 | 3/29 | ✅ 已完成 | 20 人已发送 4 轮跟进 |
